...
export const metadata: Metadata = {
  ...
  description: 'تعرف على قصة صفوة الرياض، معاييرنا القياسية في خدمات النظافة الفاخرة، وفلسفتنا في العناية بالمساكن والمنشآت الراقية بأحدث التقنيات الألمانية.',
  keywords: [
    'عن صفوة الرياض',
  ...
  openGraph: {
    ...
    description: 'قصة ورؤية صفوة الرياض في إعادة صياغة مفهوم النظافة الفاخرة والعناية بالعقارات في الرياض.',
