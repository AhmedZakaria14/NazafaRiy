...
export const metadata: Metadata = {
  ...
  description: 'تعرف على نطاق تغطية خدمات النظافة الفاخرة في كافة أحياء شمال، شرق، غرب، جنوب، ووسط مدينة الرياض مع سرعة استجابة فائقة وفرق ميدانية متخصصة.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'تغطية متكاملة لكافة أحياء الرياض مع سرعة وصول فائقة وضمان جودة 100%.',
