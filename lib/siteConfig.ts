...
export const siteConfig: SiteConfig = {
  ...
  description: "شركة تنظيف بالرياض تقدم خدمات احترافية متخصصة للمنازل، الفلل، القصور، المجالس، والمكاتب، بأحدث التقنيات وبأيدي فرق عمل مدربة على أعلى معايير العناية بالمكان.",
